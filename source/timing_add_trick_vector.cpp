...
typedef void (*function_add_vector) (int16_t* , uint16_t* , uint16_t* , uint16_t , int , int );

double perf_test(function_add_vector f, char *desc,int dim);
...
void add_function(function_add_vector f, char *name, int flops);
int validation(function_add_vector f);


/* Global vars, used to keep track of student functions */

function_add_vector userFuncs[MAX_FUNCS];
...
double perf_test(function_add_vector f, char *desc,int n)
{
	double cycles = 0.;
	double perf = 0.0;
	long num_runs = 100;
